      ...
      {posters.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-xl">
          ...
          <p className="text-gray-600 max-w-md mx-auto">
            Create your first poster by clicking the button above
          </p>
        </div>
      ) : (
            ...
            <div key={index} className="group">
              <div
                ...
                style={{
                  ...
                  backgroundImage: poster.backgroundImage
                    ...
                    ? `url(${poster.template.previewImage})`
                    : "none",
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor:
                      poster.template.overlayColor || "rgba(0,0,0,0.4)",
                  }}
                ></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-6">
            {templates.map((template, index) => (
              <Link to="/design" key={index} className="group">
                ...
                >
                  <div
                    className="absolute top-2 left-2 w-8 h-8 rounded-md flex items-center justify-center text-white text-xs font-bold"
                    style={{ backgroundColor: template.logoColor }}
                  >
                    {template.logoText}
                  </div>
                  <div
                    className="absolute top-12 left-1/2 transform -translate-x-1/2 w-3/4 h-1/3 rounded-md"
                    style={{ backgroundColor: template.imageColor }}
                  ></div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 text-center">
                    <div
                      className="h-4 rounded mb-2 mx-auto"
                      style={{
                        backgroundColor: template.titleColor,
                        width: "80%",
                      }}
                    ></div>
                    <div
                      ...
                      style={{
                        backgroundColor: template.descColor,
                        width: "60%",
                      }}
                    ></div>
                  </div>
                  {template.footerPosition && (
                    <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 w-4/5">
                      <div
                        ...
                        style={{
                          backgroundColor: template.footerColor,
                          width: "90%",
                        }}
                      ></div>
                    </div>
